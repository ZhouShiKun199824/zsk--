            ...
            <div class="left-nav-desc">
               ...
               <%-- 工作经验id--%>
                ...
                <div class="title">
                    ...
                    <a href="JavaScript:void(0)" onclick="updateOpen()"><img src="${pageContext.request.contextPath}/static/images/update.svg"
...
<script src="${pageContext.request.contextPath}/static/js/createResume.js"></script>
