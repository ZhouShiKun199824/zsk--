...
<div class="father">
    <div class="left">
        ...
        <div class="left-a" ><a href="javascript:getjobcollection()">我的收藏</a></div>
    ...
    <div class="right">
        ...
        <div class="job-div">
            <div class="div-table">
               <%-- <div class="el-title">
                    <span class="t1">职位id</span>
                    <span class="t2">公司id</span>
    ...
    <div class="resume_center">
        ...
        <div class="resume_top_op">
            <a href="/resumedelievry/getallresume/${customer.custId}">我的投递记录</a>
        ...
        <div class="rbox">
            ...
            <div class="li">
                ...
                <c:forEach items="${resumelist}" var="resume">
                    <ul class="chearfix">
                        <li class="l1"><a href="${pageContext.request.contextPath}/resume/detail/${resume.resumeId}">${resume.resumeName}</a></li>
                        <li class="l2">公开</li>
                        <li class="l3">快速投递</li>
                        <li class="l4">
                            <span><a href="${pageContext.request.contextPath}/resume/update/${resume.resumeId}">编辑</a></span>&nbsp;| |
                            <span><a href="${pageContext.request.contextPath}/resume/delete/${resume.resumeId}">删除</a></span>
                        </li>
                    </ul>
