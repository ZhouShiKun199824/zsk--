...
function savenewresume(resumename) {
    ...
    $.ajax({
        type:"get",
        url:"/resume/saveresume/"+resumename,
        datatype:"json",
...
function updatePersonInfo(){
    ...
    $.ajax({
        type:"post",
        url:"/resume/updatePersonInfo",
        data:{
            _method:"put",
            "resumeId":newresumeid,
            "resumeName":person.personName,
            "resumeGender":person.personGender,
            "resumeBirth":person.personBirthday,
            "other2":person.startWorkYear,
            "resumeTelno":person.personTel,
            "resumeLeavingWorking":person.personJObType,
            "resumeEmail":person.personEmail,
            "resumeLiveCity":person.personLoc,
            "idCardType":person.idCardType,
            "resumePersonid":person.personId
        },
...
function updateworkexperience() {
    ...
    $.ajax({
        ...
        data:{
            _method:"put",
            "workExperiId":wordexpenid,
            "workStartTime":startWorktime,
            "workEndTime":endWorkTime,
            "workCompanyName":company,
            "workPosition":companySize,
            "workDepartment":depatement,
            "workCompanyScaler":experJobLevel,
            "workCompanyProperty":companyType,
            "workDesc":jobDescription,
            "workType":experJobType
        },
        success:function(result){
            console.log(result);
            if(result.status ==1){
...
function updateprojectexperience() {
    ...
    $.ajax({
        ...
        data:{
            _method:"put",
            "projectExperiId":projectexperid,
            "projectStartTime":startprotime,
            "projectEndTime":endproTime,
            "projectCompanyName":proCompany,
            "projectName":proName,
            "projectContentDesc":proDesc,
            "projectDutyDesc":proDuty
        },
        datatype:"json",
        success:function (result) {
            if (result.status==1){
...
function initEdu() {
    ...
    for (var i = 0; i < eduList.length; i++) {
        ...
        var eduHtml = "<div class=\"jes-content\">\n" +
            ...
            "                            <a href=\"javascript:void(0)\" class=\"jes-update\"><img src=\"${pageContext.request.contextPath}/static/images/update.svg\"></a>\n" +
            "                            <a href=\"javascript:void(0)\" class=\"jes-delete\"><img src=\"${pageContext.request.contextPath}/static/images/delete.svg\"></a>\n" +
